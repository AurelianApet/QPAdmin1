        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class=" box Tmg7 sortable">
                ...
                <tr class="bold">        
                    ...
                    <th class="listTitle2"><a class="l1" href="" onclick="GetOrder('UserID',this)">昵称</a></th>                  
                    ...
                    <th class="listTitle2"><a class="l1" href="" onclick="GetOrder('Score',this)">奖牌</a></th>
                    <th class="listTitle2"><a class="l1" href="" onclick="GetOrder('UserID',this)">已兑换魅力</a></th>
                    ...
                    <th class="listTitle2"><a class="l1" href="" onclick="GetOrder('WinCount',this)">总局</a></th>
                ...
                <tr align="center" class="<%=className %>" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                    ...
                    <td><%=rs(3,i) %></td>      
                    <td><%=rs(4,i)+rs(5,i)+rs(6,i)+rs(7,i) %></td>   
                    <td><%=rs(4,i) %></td>      
                    <td><%=rs(5,i) %></td>       
                    <td><%=rs(6,i) %></td>       
                    <td><%=rs(7,i) %></td>       
