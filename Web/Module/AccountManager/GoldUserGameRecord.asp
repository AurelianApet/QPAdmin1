...
<body>
    ...
    <% 
        ...
        Sub Main()
            ...
            Dim fields
            fields = "DrawID,InsertTime,KindID,ServerID,TableID,UserCount,AndroidCount,Waste,Revenue,UserMedal,StartTime,ConcludeTime"
    ...
    <form name="myformList" method="post" action="">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box Tmg7">
            <tr align="center" class="bold">
                ...
                <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('TableID',this)">桌子</a></th>
                <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('UserCount',this)">用户数</a></th>
                <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('AndroidCount',this)">机器人数</a></th>
                <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('Waste',this)">损耗</a></th>
                <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('Revenue',this)">税收/服务费</a></th>   
                <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('UserMedal',this)">奖牌</a></th> 
                ...
                <td colspan="100"> 
                    <table width="100%" border="0" align="center">
                        <tr class="list" align="center">
                            ...
                            <td style="font-weight:bold;">是否机器人</td>
                            <td style="font-weight:bold;">椅子号</td>
                            <td style="font-weight:bold;">输赢积分</td>
                            <td style="font-weight:bold;">税收/服务费</td>
                            <td style="font-weight:bold;">奖牌数目</td>
                            <td style="font-weight:bold;">游戏时长</td>
            ...
            %>
                <tr class="list" align="center">
                    ...
                    <td><%=CxGame.GetUserAndroidStatus(rs_d("UserID")) %></td>
                    <td><%=rs_d("ChairID") %></td>
                    <td><%=rs_d("Score") %></td>
                    <td><%=rs_d("Revenue") %></td>                    
                    <td><%=rs_d("UserMedal") %></td>
                    <td><%=rs_d("PlayTimeCount") %></td>
