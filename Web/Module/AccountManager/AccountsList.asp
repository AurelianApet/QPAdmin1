...
<body>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
            <tr>
              ...
              <td>
                    ...
                    <a href="AdduserMore.asp"><strong>批量添加帐号</strong></a></td>
            </tr>
        </table>
    </form>
    <div id="divQuery" class="querybox">
        <form name="form2" action="" onsubmit="return CheckForm()">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
	            ...
	            <tr>
	                <td class="listTdLeft" style="width:100px;">用户状态：</td>
	                <td>
	                    <input type="checkbox" name="in_ProtectID" id="in_ProtectID" value="1" /><label for="in_ProtectID">申请密保</label>           
	                    <input type="checkbox" name="in_MemberOrder" id="in_MemberOrder" value="1" /><label for="in_MemberOrder">会员</label>                 
	                    <input type="checkbox" name="in_Nullity" id="in_Nullity" value="1" /><label for="in_Nullity">冻结</label>        
	                    <input type="checkbox" name="in_IsAndroid" id="in_IsAndroid" value="1" /><label for="in_IsAndroid">机器人</label>              
	                </td>
	            </tr>
	            <tr>
                ...
                <tr>
	                ...
	                <td>
	                    <input name="ReStartDate" type="text" class="text" style="width:100px;" maxlength="10" /><img src="../../Images/btn_calendar.gif" onclick="calendar(ReStartDate)" style="cursor:pointer;vertical-align:middle"/> 
	                    至
	                    <input name="ReEndDate" type="text" class="text" style="width:100px;" maxlength="10" /><img src="../../Images/btn_calendar.gif" onclick="calendar(ReEndDate)" style="cursor:pointer;vertical-align:middle"/>                                     
	                </td>
	            </tr>
	            <tr>
	                <td class="listTdLeft" style="width:100px;">登录日期：</td>
	                <td>
	                    <input name="LoStartDate" type="text" class="text" style="width:100px;" maxlength="10" /><img src="../../Images/btn_calendar.gif" onclick="calendar(LoStartDate)" style="cursor:pointer;vertical-align:middle"/> 
	                    至
	                    <input name="LoEndDate" type="text" class="text" style="width:100px;" maxlength="10" /><img src="../../Images/btn_calendar.gif" onclick="calendar(LoEndDate)" style="cursor:pointer;vertical-align:middle"/>                                     
	                </td>
	            </tr>
	            <tr>
    ...
    <% 
        ...
        '机器人设置
        Sub SetAndroid(lID,typeValue)
            Dim ID
            ID = lID
            GameConn.execute "Update AccountsInfo Set IsAndroid="&typeValue&" Where UserID="&lID
        End Sub
        ...
        Sub Main()            
            ...
            For lLoop=0 To UBound(cidArray)
                Select case acType
                    ...
                    case "AndroidOn"
                        Call SetAndroid(cidArray(lLoop),1)
                    case "AndroidOff"
                        Call SetAndroid(cidArray(lLoop),0)
                End Select
            Next            
            ...
            If CxGame.GetInfo(0,"QueryType")<>"" Then
	            ...
	            '是否有密保  
	            If CxGame.GetInfo(0,"in_ProtectID")<>"" Then
	                queryCondition = queryCondition& " And ProtectID<>0"
	            End If    
	            
	            '是否是会员
	            If CxGame.GetInfo(0,"in_MemberOrder")<>"" Then
	                queryCondition = queryCondition& " And MemberOrder<>0"
	            End If 
	            
	            '是否被冻结
	            If CxGame.GetInfo(0,"in_Nullity")<>"" Then
	                queryCondition = queryCondition& " And Nullity=1"
	            End If 
	            
	            '是否机器人
	            If CxGame.GetInfo(0,"in_IsAndroid")<>"" Then
	                queryCondition = queryCondition& " And IsAndroid=1"
	            End If 
    ...
    <script type="text/javascript">        
        function Operate(opType)
        {
            ...
            else
            {
                ...
                if(opType=="AndroidOn")
                    opVal.value = "AndroidOn";
                if(opType=="AndroidOff")
                    opVal.value = "AndroidOff";
            }
    ...
    <form name="myformList" method="post" action=''>
        ...
        <% 
            End If              
        %>
        <% If Request("action") = "AndroidOn" Then %>
        <script type="text/javascript">
            showInfo("设置机器人成功")
        </script>
        <% 
            End If              
        %>
        <% If Request("action") = "AndroidOff" Then %>
        <script type="text/javascript">
            showInfo("取消机器人成功")
        </script>
        <% 
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
            <tr>
                <td height="39" class="titleOpBg">
                    ...
                    <input type="button" value="设置机器人" class="btn wd2" onclick="Operate('AndroidOn')"/>
                    <input type="button" value="取消机器人" class="btn wd2" onclick="Operate('AndroidOff')"/>
        ...
        <div id="content">   
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle2"><a class="l1"  href="" onclick="GetOrder('Present',this)">已兑换魅力</a></td>
