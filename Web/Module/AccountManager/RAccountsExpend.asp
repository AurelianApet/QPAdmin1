...
<head>
    ...
    <title>“<%=CxGame.GetUserNameByUserID(Request("id")) %>”历史改昵称记录</title>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">前操作功能：历史改昵称记录</td>
        </tr>
    </table>
    <!-- 头部菜单 End -->
    <% 
        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                <tr align="center" class="bold">
                    ...
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('ReAccounts',this)">更新昵称</a></th>
