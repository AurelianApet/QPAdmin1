...
<body>
    ...
    <% 
        ...
        Sub SaveRoomInfo()
            ...
            rs("CellScore") = CxGame.GetInfo(0,"in_CellScore")
            rs("RevenueRatio") = CxGame.GetInfo(1,"in_RevenueRatio")
            rs("RestrictScore") = CxGame.GetInfo(0,"in_RestrictScore")
            rs("MinTableScore") = CxGame.GetInfo(0,"in_MinTableScore")
            rs("MinEnterScore") = CxGame.GetInfo(0,"in_MinEnterScore")
            rs("MaxEnterScore") = CxGame.GetInfo(0,"in_MaxEnterScore")
            ...
            rs("ServiceMachine") = CxGame.GetInfo(0,"in_ServiceMachine")
            rs("CustomRule") = CxGame.GetInfo(0,"in_CustomRule")
            rs("Nullity") = CxGame.GetInfo(1,"in_Nullity")
            rs("ServerNote") = CxGame.GetInfo(0,"in_ServerNote")
