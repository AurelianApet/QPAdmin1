        ...
        <div id="content">        
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                <tr align="center" class="bold">
                    ...
                    <th class="listTitle1" style="width:100px;"><a class="l1"  href="" onclick="GetOrder('RoleID',this)">组别标识</a></th>
                    <th class="listTitle2"><a class="l1"  href="" onclick="GetOrder('RoleName',this)">组别名称</a></th>
