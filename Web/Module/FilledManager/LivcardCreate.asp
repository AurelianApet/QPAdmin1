...
<body>
    ...
    <form name="myFormInfo" method="post" action="?action=create" onsubmit="return CheckFormInfo()">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
	        ...
	        <tr>
                <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10"><div class="hg3  pd7 hong">说明</div></td>
            </tr>
            <tr>
                <td colspan="2" style="height:35px;padding-left:20px;">1.同一分钟内不能生成同一类型的卡多次，会造成卡号重复现象。</td>
            </tr>
        </table>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
