...
<body>
    ...
    <% 
        ...
        Sub Main()
            ...
            sql = "select Sum(CardPrice) as CardPriceSum ,sum(CardGold) as CardGoldSum,sum(OrderAmount) as OrderAmountSum,sum(PayAmount) as PayAmountSum from ShareDetailInfo where "&queryCondition
