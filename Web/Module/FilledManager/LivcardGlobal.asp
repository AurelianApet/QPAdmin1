...
<body>
    ...
    <% 
        ...
        Sub Save()
            Dim rs,sql
            Dim UserRightArr,UserRight,RL_i
    ...
    <% 
        ...
        Sub GetCardInfo()
            ...
            Dim cardTypeID,cardName,cardPrice,cardGold,memberOrder,memberDays,userRight
            Set rs=Server.CreateObject("Adodb.RecordSet")            
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
	        ...
	        <tr>
	            ...
	            <td>
                    ...
                    <tr>
                        <td><input name="in_UserRight" id="in_UserRight1" type="checkbox" value="256"<% If userRight And 256 Then %> checked='checked'<% End If %> /><label for="in_UserRight1">游戏双倍积分</label></td>           
                        <td><input name="in_UserRight" id="in_UserRight2" type="checkbox" value="512"<% If userRight And 512 Then %> checked='checked'<% End If %>/><label for="in_UserRight2">游戏踢出用户</label></td>
                        <td><input name="in_UserRight" id="in_UserRight3" type="checkbox" value="268435456"<% If userRight And 268435456 Then %> checked='checked'<% End If %>/><label for="in_UserRight3">游戏比赛用户</label></td>
                    </tr> 
                    </table>   
	            </td>
	        </tr>	        
