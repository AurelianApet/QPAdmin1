...
<div><a href="Index.asp" class="f">后台首页</a> | <a href="Login.asp?Action=Logout" class="f">安全退出</a>| <% If CxGame.GetIPBandValue()="0" Then %> 
    <a href="BandIP.asp?Action=unband" class="f" >解除绑定</a><% Else %> <a href="BandIP.asp?Action=band" class="f" >绑定IP</a><% End If %>
    | <a href="payManage.asp" class="f">手动充值管理</a>
</div>
</div>
